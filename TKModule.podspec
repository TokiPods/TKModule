...
Pod::Spec.new do |s|
  s.name             = 'TKModule'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TKModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xianda.zheng/TKModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xianda.zheng' => 'xianda.zheng@email.com' }
  s.source           = { :git => 'https://github.com/xianda.zheng/TKModule.git', :tag => s.version.to_s }
